...
class BottomNavigationBarWithAddress_OrderScreen extends StatefulWidget {
  ...
  const BottomNavigationBarWithAddress_OrderScreen({
  ...
  @override
  _BottomNavigationBarWithAddress_OrderScreenState createState() =>
      _BottomNavigationBarWithAddress_OrderScreenState();
}

class _BottomNavigationBarWithAddress_OrderScreenState
    extends State<BottomNavigationBarWithAddress_OrderScreen> {
