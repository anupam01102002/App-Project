...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> postRequest(
    ...
    var url =
        'http://msocial-ecommerce.shivinfotechsolution.in/api/v1/address/update';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text("Failed to Edit Address"),
          ),
        );
      }
    } catch (error) {
          ...
          children: [
            ...
            Padding(
              ...
              child: Container(
                height: 55,
                child: TextFormField(
                  // initialValue: widget.streetAddress,
            ...
            Padding(
              ...
              child: Container(
                height: 55,
                child: TextFormField(
                  // initialValue: widget.landmarkName,
